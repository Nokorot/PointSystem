...
public class LinePart implements Logable {
	private Vec2f v0;
	private Vec2f v1;
	private float a;
	private float b;
	...
	public String toLogString() {
		return this.v0.toLogString() + ", " + this.v1.toLogString() + ", " + this.a + ", " + this.b;
	}

	public void fromLogString(String s) {
		String[] v = s.split(", ");
		this.v0 = new Vec2f(Float.parseFloat(v[0]), Float.parseFloat(v[1]));
		this.v1 = new Vec2f(Float.parseFloat(v[2]), Float.parseFloat(v[3]));
		this.a = Float.parseFloat(v[4]);
		this.b = Float.parseFloat(v[5]);
	}
}