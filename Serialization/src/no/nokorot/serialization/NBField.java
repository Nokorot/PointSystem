...
public class NBField extends RCBase {
	...
	private NBField(String name, Object data, byte type) {
		super(1 + 1);
		this.type = type;
		setName(name);
		setData(data);
	...
	public static NBField Deserialize(byte[] src, int pointer) {
		...
		return new NBField(name, data, type);
	}
	...
	public static NBField Byte(String name, byte value) {
		return new NBField(name, value, Type.BYTE);
	}

	public static NBField Short(String name, short value) {
		return new NBField(name, value, Type.SHORT);
	}

	public static NBField Char(String name, char value) {
		return new NBField(name, value, Type.CHAR);
	}

	public static NBField Integer(String name, int value) {
		return new NBField(name, value, Type.INTEGER);
	}

	public static NBField Long(String name, long value) {
		return new NBField(name, value, Type.LONG);
	}

	public static NBField Float(String name, float value) {
		return new NBField(name, value, Type.FLOAT);
	}

	public static NBField Double(String name, double value) {
		return new NBField(name, value, Type.DOUBLE);
	}

	public static NBField Booelan(String name, boolean value) {
		return new NBField(name, value, Type.BOOLEAN);
	}
